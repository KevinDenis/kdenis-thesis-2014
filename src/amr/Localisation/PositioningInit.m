function [position,plotPos,indices,prevProbability] = PositioningInit(totalProbability,pred,map)
...
indices = find(meanProbability == max(meanProbability)); %Save index of particle with highest mean
prevProbability = meanProbability;                %The probability of best particle
